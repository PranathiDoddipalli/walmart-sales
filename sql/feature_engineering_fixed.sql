...
ALTER TABLE sales ADD COLUMN quarter INT;
ALTER TABLE sales ADD COLUMN season VARCHAR(10);
ALTER TABLE sales ADD COLUMN customer_segment VARCHAR(50);
ALTER TABLE sales ADD COLUMN sales_performance_index DECIMAL(10,2);
